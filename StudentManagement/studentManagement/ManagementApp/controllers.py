...
from studentManagement.ManagementApp import dao
from studentManagement.ManagementApp import get_data_news
from studentManagement.ManagementApp.management_database import *
from studentManagement.ManagementApp.decorater import *
import cloudinary.uploader
from flask_login import login_user, login_required
import json
from studentManagement.ManagementApp.handle_add_student.handle_students import *
from studentManagement.ManagementApp.handle_add_student import semester_active
from studentManagement.ManagementApp.handle_score import handle_score
# trang chủ + login
def main():
    password =""
    username = ""
...
#hiển thị trang mặc định của giáo vụ
@login_required
@check_permission_register
...
def add_student():
    ...
    try:
            ...
            # tạo student và add vào database
...
# trang chọn học kỳ thành công
def lms(id):
    # lấy năm
    id_year = id
    print("id năm hoc lay dc la",id_year)
    # lấy tất cả lớp trong năm học này
    ...
    # Phân ra 3 khối để bên kia render
...
def render_template_score(id_year,id_class,id_subject):
    ...
    # truyền rule về môn học để môn học đó ràng buộc cột điểm
...
# Điểm được nhập theo quy định của rule_subject

# xuất bảng điểm
def page_table_average(id_class,id_subject,id_school_year):
    #  cần lấy id lớp, để lấy danh sách hs
